...
class GitHubTools:
    ...
    def create_issue_tool(self) -> Tool:
        ...
        async def create_issue(params: Dict[str, Any]) -> TextContent:
    ...
    def create_pr_tool(self) -> Tool:
        ...
        async def create_pr(params: Dict[str, Any]) -> TextContent:
    ...
    def list_issues_tool(self) -> Tool:
        ...
        async def list_issues(params: Dict[str, Any]) -> TextContent:
